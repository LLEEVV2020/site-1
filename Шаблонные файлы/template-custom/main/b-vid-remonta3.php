<div class="wrap-b-vid-remonta" id="b-vid">
    <div class="b-vid-remonta _white">
        ...
        <div class="container">
            <div  class="h2">популярные модели шкафов по низким ценам</div>

            <div class="b-vid-remonta__block">
               
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-1.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>встроенный шкаф с зеркалом</span></div>
                ...
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-2.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>полукруглый угловой шкаф в современном стиле</span></div>
                    <div class="b-vid-remonta__item_spisok">
                        <ul class="check">
                            <li>Готовый / на заказ</li>
                            <li>Корпусный / встроенный</li>    
                ...
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-3.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>угловой шкаф</span></div>
                    <div class="b-vid-remonta__item_spisok">
                        <ul class="check">
                            <li>Готовый / на заказ</li>
                            <li>Корпусный / встроенный</li>    
                ...
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-4.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>угловой шкаф-купе</span></div>
                    <div class="b-vid-remonta__item_spisok">
                        <ul class="check">
                            <li>Готовый / на заказ</li>
                            <li>Корпусный / встроенный</li>    
                ...
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-5.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>шкаф в гостиную</span></div>
                    <div class="b-vid-remonta__item_spisok">
                        <ul class="check">
                            <li>Готовый / на заказ</li>
                            <li>Корпусный / встроенный</li>    
                ...
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-6.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>шкаф в детскую</span></div>
                    <div class="b-vid-remonta__item_spisok">
                        <ul class="check">
                            <li>Готовый / на заказ</li>
                            <li>Корпусный / встроенный</li>    
                ...
                <div class="b-vid-remonta__item">
                    <div class="b-vid-remonta__item_pict"><img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/vid-remonta/vid-remonta-7.jpg" /> </div>
                    <div class="b-vid-remonta__item_ttl"><span>шкаф в классическом стиле</span></div>
                    <div class="b-vid-remonta__item_spisok">
                        <ul class="check">
                            <li>Готовый / на заказ</li>
                            <li>Корпусный / встроенный</li>    
                ...
                <div class="b-vid-remonta__item">
                    ...
                    <div class="b-vid-remonta__item">
                     ...
                     <div class="b-vid-remonta__item">
                       ...
                       <div class="b-vid-remonta__item b-vid-remonta__item_l">
                       ...
                       <div class="b-vid-remonta__item b-vid-remonta__item_r">
    ...
    <style>
        .b-vid-remonta__item_r{
            margin-right: 18%;
        }
        .b-vid-remonta__item_l{
            margin-left: 18%;
        }
