 <div class="b-way">
            <div class="container">
                <div class="h2">ПОЧЕМУ ЗАКАЗЫВАТЬ В компании «Купить шкаф» ВСЕГДА ЛУЧШЕ?</div>
                ...
                <div class="b-way__item">
                    ...
                    <div class="b-way__item_info">Компания «Купить шкаф» имеет собственное производство, что позволяет разрабатывать и создавать абсолютно любые шкафы! Это позволяет избежать ненужных наценок, без которых дилеры обойтись не смогут.
                            </div>
                </div>
                <div class="b-way__item">
